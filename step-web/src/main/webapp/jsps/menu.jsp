...
<div class="headerButtons pull-right">
    ...
    <a id="report-icon" style="padding-left:5px" class="hidden-xs hidden-sm navbarIconDesc" href="/html/reports_folder.html;" target="_blank" title="Reports that uses STEP">
