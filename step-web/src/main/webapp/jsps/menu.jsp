...
<div class="headerButtons pull-right">
    ...
    <a id="report-icon" style="padding-left:5px" class="hidden-xs hidden-sm navbarIconDesc" href="/html/reports_by_step.html" target="_blank" title="Reports that uses STEP">
        <i class="glyphicon glyphicon-th-list"></i><span class="navbarIconDesc">&nbsp;&nbsp;Reports</span>
    </a>
