		...
		'<div id="welcomeExamples" class="passageContainer examplesContainer">' +
			...
			'<div class="accordion-row" data-row="0">' +
				...
				'<div class="accordion-body">' +
					'<br>' +
					'<div id="classicalUIVideo"><span style="font-size:14px;font-weight:bold;color:var(--stepTextColor)"><mark><%= __s.display_classical_ui %></mark></span>' +
					...
					'<span id="quickTour"><span style="font-size:14px;font-weight:bold;color:var(--stepTextColor)"><%= __s.quick_tour %></span>' +
            ...
            '<div id="keyboard_shortcut" class="accordion-row" data-row="3" style="display:none">' +
				...
				'<div class="accordion-body">' +
					'<br>' +
					'<div><span style="font-size:14px;font-weight:bold;color:var(--stepTextColor)"><%= __s.keyboard_explain1 %></span>' +
